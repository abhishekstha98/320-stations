...
if __name__ == "__main__":
    ...
    test_data_path = 'D:/ICIMOD/YASH_PROCESS/TEST/test_data.csv'
    stations_path = 'D:/ICIMOD/YASH_PROCESS/TEST/stations.txt'
    locations_path = "D:/ICIMOD/YASH_PROCESS/TEST/locations.csv"
    weights_path = 'D:/ICIMOD/YASH_PROCESS/TEST/NW_WT/Model_43Lags_STConv_Last.pth'
    edge_index_path = 'D:/ICIMOD/YASH_PROCESS/TEST/edge_index.pt'
    edge_weight_path = 'D:/ICIMOD/YASH_PROCESS/TEST/edge_weights.pt'
    
    mean_file_path = "D:/ICIMOD/YASH_PROCESS/TEST/mean_values.csv"
    std_file_path = "D:/ICIMOD/YASH_PROCESS/TEST/std_values.csv"
    ...
    print(f"y_pred for new locations (for ({pred_seq}) days): \n\n{y_pred_new_location}")
